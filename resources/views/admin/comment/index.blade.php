...
@section('content')
			...
			<main class="content">
				<div class="container-fluid p-0">
                    <div class="btn-group mb-3" role="group" aria-label="Comment Modification">
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <!-- Cardholder START -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card ">
                                        ...
                                        <div class="card-header">
                                            <strong class="card-title mb-0">Comment List</strong>
                                        </div>
                                        <!-- /.card-header -->
                                        <!-- card-body -->
                                        <div class="card-body">
                                                    ...
                                                    <table class="table table-hover my-0" aria-labelledby="Comment List">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="d-none d-md-table-cell"><a href="{{route('admin.place.show', ['id'=>$rs->place_id])}}">{{$rs->place->title}}</a></td>
                                                                ...
                                                                <td><a href="{{route('admin.comment.destroy', ['id'=>$rs->id])}}" class="btn  btn-sm btn-danger" style="text-decoration: none">
                                                                    <i class="align-middle" data-feather="trash-2"></i>Delete
                                                                </a></td>
                                                                <td><a  href="{{route('admin.comment.show', ['id'=>$rs->id])}}" class="btn btn-sm btn-success" style="text-decoration: none"
