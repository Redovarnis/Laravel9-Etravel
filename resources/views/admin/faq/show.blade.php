...
@section('content')
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3 "> Edit FAQ: <div class="text-primary btn badge bg-white text-dark ms-2 " > {{$data->title}} </div> </h1>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-6">
                                            <div class="card">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="{{route('admin.faq.destroy', ['id'=>$data->id])}}" class="btn  btn-sm btn-danger" style="text-decoration: none"
